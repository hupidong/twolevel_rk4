...
int main(int argc, char* argv[])
{
	...
	ofstream time_output("res\\time.txt",ofstream::out);
	ofstream lasersource_output("res\\source.txt",ofstream::out);
	...
	relative_parameters.open("res\\relative_parameters.dat", ios_base::out | ios_base::binary);
	...
	ofstream dipole("res\\dipole.txt", ofstream::out);
	double dipole_tmp;
	for (i = 0; i < (NT-1); i++){
